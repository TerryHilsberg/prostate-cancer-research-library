...
Research notes and filed articles for **diagnostic workup**.
...
- [AI and Integrated Test Decision Support in Prostate Cancer: Evidence Map](../papers/ai-integrated-prostate-cancer-decision-support-evidence/index.md) — biopsy-decision and lesion-targeting tools that combine PSA, PSA density, mpMRI/PI-RADS, biomarkers, PSMA PET/CT, and biopsy/pathology evidence.
