...
Research notes and filed articles for **screening & early detection**.
...
- [Genetic and Epigenetic Background to Prostate Cancer Risk: Evidence Map](../papers/genetic-epigenetic-risk-prostate-cancer-evidence/index.md) — inherited variants, family history, Ashkenazi Jewish/APOE/BRCA clarification, polygenic risk scores, epigenetic biomarkers, and how they may eventually inform personalized screening intensity.
